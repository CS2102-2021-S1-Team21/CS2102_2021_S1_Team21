...
export default function TransferList({ categories, handleSubmit }) {
  ...
  const [left, setLeft] = React.useState(categories.notSelectedResult.map((x) => x.categoryname));
  const [right, setRight] = React.useState(categories.selectedResult.map((x) => x.categoryname));
