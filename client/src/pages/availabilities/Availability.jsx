    ...
    <Container>
      <Card className={classes.root}>
        <CardContent>
          ...
          <p>Note: <br></br>
            - Availability cannot have overlapping dates (Even if start and end date is same) <br></br>
            - Start and end date starts and ends at 8am respectively. Eg: If you want to indicate your availability on Monday 11th January 2020, <br></br>
            you have put it as FROM: 11/01/2020 TO: 12/01/2020 (Not TO: 11/01/2020) </p>
